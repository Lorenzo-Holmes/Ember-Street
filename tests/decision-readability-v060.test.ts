...
function eventWith(id: string, choice: NightChoice): V060NightEvent {
  ...
  return { id, category: 'emergency', visualKey: 'night_external_threat', audioKey: 'night_distant_threat', minDay: 1, maxDay: 29, title: '测试事件', body: '测试。', choices: [choice, noop, { ...noop, id: 'noop-2' }] };
}
