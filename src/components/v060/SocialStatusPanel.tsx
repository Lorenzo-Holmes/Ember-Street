...
import { choosePrinciple, pendingPrincipleDecision, principleTitle } from '../../game/v060/principles';
  ...
  return (
    <section className="v6-section">
      ...
      {!!social.principles.length && <div className="v6-survivor__status" style={{ marginTop: 10 }}>
        {social.principles.map((id) => <span key={id}>原则 · {principleTitle(id)}</span>)}
      </div>}
