 ...
 * All A01-A29 runtime masters were explicitly confirmed by the user.
 * Runtime uses one independent local WebP per canonical asset for deterministic crop,
 * replacement and offline packaging in the Xiaohongshu mini-tool container.
 */
