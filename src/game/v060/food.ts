...
function rationStretchFor(state: GameState, cooks: Survivor[], residentCount: number, availableRations: number): number {
  ...
  // A staffed kitchen can turn scraps, broth and leftovers into one extra portion.
  // At a mature shelter with a larger community, organized batch cooking can save one more.
