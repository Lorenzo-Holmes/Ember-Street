...
export const EXPANDED_NORMAL_NIGHT_EVENTS: V060NightEvent[] = [
  {
    ...
    audioKey: 'night_structure_creak',
    minDay: 1,
    maxDay: 12,
    title: '南口雨棚一直在敲铁皮',
  ...
  },
  {
    ...
    audioKey: 'night_conflict_murmur',
    minDay: 1,
    maxDay: 10,
    title: '有人为了两床厚毯子僵住了',
  ...
  },
  {
    ...
    audioKey: 'night_departure_steps',
    minDay: 12,
    maxDay: 28,
    title: '有人抱着包睡在门边',
